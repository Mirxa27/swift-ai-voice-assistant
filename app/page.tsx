    ...
    <>
      {crisis && (
        <div className="p-4 mb-4 bg-red-100 border border-red-300 rounded text-red-800 max-w-xl text-center space-y-2">
          <p>
            It sounds like you are going through a very difficult time. For
            immediate help, please contact the Saudi crisis hotline at{" "}
            <a href="tel:937" className="underline">
              937
            </a>{" "}
      ...
      <div className="space-y-4 text-center mb-6 max-w-xl mx-auto">
        <h1 className="text-2xl font-bold">{headline}</h1>
        <p className="text-sm text-neutral-600 dark:text-neutral-400">{affirmation}</p>
        {focus.length > 0 ? (
          <div className="space-y-3 pt-2">
            {focus.map((area) => (
              <div key={area}>
                ...
                <div className="h-2 bg-neutral-200 dark:bg-neutral-700 rounded mt-1">
                  <div
      ...
      >
        <input
          ...
          ref={inputRef}
          disabled={crisis || isPending}
        />

        <button
          type="submit"
          className="p-4 text-neutral-700 hover:text-black dark:text-neutral-300 dark:hover:text-white disabled:opacity-50"
          disabled={isPending || crisis || !input}
          aria-label="Submit"
        >
      ...
      <div className="text-neutral-500 dark:text-neutral-600 pt-4 text-center max-w-xl text-balance min-h-28 space-y-4">
        {messages.length > 0 && (
          <p>
            {messages.at(-1)?.content}
            <span className="text-xs font-mono text-neutral-400 dark:text-neutral-700">
              {" "}
        ...
        {messages.length === 0 && (
          <>
            ...
            <div className="flex justify-center gap-4 text-sm">
                ...
                <A href="/balance">Balance Wheel</A>
